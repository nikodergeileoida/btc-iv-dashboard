...
view_mode = st.sidebar.radio("Modus wählen:", ["📊 Live-Chart (Echte Marktdaten + Ticker)", "🧊 Riemannsches Raumgitter (120 FPS 3D-Fläche)"])
...
if "Chart" in view_mode:
    ...
    <body>
        <div class="market-badge">MARKET_PLACEHOLDER: $PRICE_PLACEHOLDER (Vol-Index: VOL_PLACEHOLDER)</div>
    ...
    st.caption(f"ℹ️ **Riemannsches Raumgitter (120 FPS):** Gekoppelt an die Volatilität von **{selected_market}**.")
